...
router.post("/createBlog", middleware, upload.single('UploadImages'), /*#__PURE__*/function () {
...
router.patch("/update/:edit_id", middleware, upload.single('UploadImages'), /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var post, upl, result, blog;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return Blog.findById(req.params.edit_id);
        case 3:
          post = _context3.sent;
          console.log(post.img);
          _context3.next = 7;
          return cloudinary.uploader.destroy(post.img);
        case 7:
          upl = _context3.sent;
          _context3.next = 10;
          return cloudinary.uploader.upload(req.file.path);
        case 10:
          ...
          _context3.next = 13;
          return Blog.findByIdAndUpdate(req.params.edit_id, {
            $set: req.body
          }, {
            "new": true
          });
...
router["delete"]("/delete/:edit_id", middleware, /*#__PURE__*/function () {
...
router.get("/:req_id", /*#__PURE__*/function () {
...
router.post("/likes/:id", middleware, /*#__PURE__*/function () {
...
router.post("/unlikes/:id", middleware, /*#__PURE__*/function () {
...
router.post('/CreateComment/:id', middleware, /*#__PURE__*/function () {
...
router.get("/GetComment/:id", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          _context9.next = 3;
          return coments.findOne();
        case 3:
          comnt = _context9.sent;
          res.send(comnt);
          _context9.next = 10;
          break;
        case 7:
          ...
          res.status(404).json(_context9.t0);
        case 10:
        case "end":
